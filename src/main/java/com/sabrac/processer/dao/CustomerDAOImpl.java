 ...
 * @see com.sabrac.processer.model.Customer
...
public class CustomerDAOImpl implements CustomerDAO {
    ...
    public Customer findById(java.lang.Integer id) {
        ...
        try {
            Customer instance = (Customer) sessionFactory.getCurrentSession().get("com.sabrac.processer.model.Customer",
                    id);
            if (instance == null) {
    ...
    public List<Customer> findByExample(Customer instance) {
        ...
        try {
            List<Customer> results = (List<Customer>) sessionFactory.getCurrentSession()
                    .createCriteria("com.sabrac.processer.model.Customer").add(create(instance)).list();
