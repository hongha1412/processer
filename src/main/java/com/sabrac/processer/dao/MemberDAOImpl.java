 ...
 * @see com.sabrac.processer.model.Member
...
public class MemberDAOImpl implements MemberDAO {
    ...
    public Member findById(int id) {
        ...
        try {
            Member instance = (Member) sessionFactory.getCurrentSession().get("com.sabrac.processer.model.Member", id);
            if (instance == null) {
    ...
    public List<Member> findByExample(Member instance) {
        ...
        try {
            List<Member> results = (List<Member>) sessionFactory.getCurrentSession()
                    .createCriteria("com.sabrac.processer.model.Member").add(create(instance)).list();
