$(document).ready(function () {
    ...
    var colDataFunc = (row, type, set, meta) => {
        meta.col;
        meta.row;
        meta.settings;
        switch (type) {
    ...
    var colRenderFunc = (data, type, row, meta) => {
        meta.col;
        meta.row;
        meta.settings;
        switch (type) {
    ...
    var rowCallbackFunc = function (row, data, index) { };
    ...
    var ajaxDataFunc = function (data, settings) {
        return data;
    };
    ...
    var row_22 = dt.row("selector").id();
    var row_23 = dt.row("selector").id(false);
    var rows_1 = dt.rows();
    ...
    var rows_14 = dt.rows("selector").ids();
    var rows_15 = dt.rows("selector").ids(false);
...
//# sourceMappingURL=datatables.net-tests.js.map