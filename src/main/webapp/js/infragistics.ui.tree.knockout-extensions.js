/*!@license
 * Infragistics.Web.ClientUI igTree KnockoutJS extension 13.2.20132.2417
 *
...
ko.bindingHandlers.igTreeNode = {
    init: function(element, valueAccessor) {
        ...
        if (children.length > 0) {
            ko.applyBindingsToNode(children[0], {
                igTreeNodeCollection: {
                    value: ds[bindings.childDataProperty],
                    bindings: bindings
                }
            }, ds[bindings.childDataProperty])
        }
    },
    update: function(element, valueAccessor) {
